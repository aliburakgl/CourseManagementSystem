...
public class addCourses extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton3.setText("Tum Ogrenciler");
        ...
        jButton4.setText("Tum Egitmenler");
    ...
    private void insertCourseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_insertCourseActionPerformed
         if (courseID.getText().isBlank() == true ||courseName.getText().isBlank() == true || coursePrice.getText().isBlank() == true
                 || roomNumber.getText().isBlank() == true){
            JOptionPane.showMessageDialog(null, "Eksik data var lutfen guncelleyip tekrar deneyin."
        ...
        try {
            ...
            pst.setString(3, "TL "+coursePrice.getText());
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        coursePrice.setText(model.getValueAt(selectedRow, 3).toString().replace("TL",""));

...
public class Instructor extends javax.swing.JFrame{
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Ogrenci ID");

        jLabel3.setFont(new java.awt.Font("Dialog", 1, 12)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("Kurs ID");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        JOptionPane.showMessageDialog(this , "Basariyla cikis yapildi");
    ...
    private void deleteScoreButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteScoreButtonActionPerformed
        if (studentID.getSelectedIndex() == 0 || courseID.getSelectedIndex() == 0){
            JOptionPane.showMessageDialog(null, "Data silinemedi, ID secin." , "ERROR" , JOptionPane.ERROR_MESSAGE);
        }
        else{
        try {
    ...
    public void updateStudentCombo(){
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Data guncellenemedi. ID seciniz." , "ERROR" , JOptionPane.ERROR_MESSAGE);
        }
    ...
    public void updateCourseCombo(){
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Data Guncellenemedi." , "ERROR" , JOptionPane.ERROR_MESSAGE);
        }
    }
